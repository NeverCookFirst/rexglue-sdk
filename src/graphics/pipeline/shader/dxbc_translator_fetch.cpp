...
void DxbcShaderTranslator::ProcessTextureFetchInstruction(
  ...
  if (instr.opcode == FetchOpcode::kGetTextureWeights) {
    ...
    if (instr.opcode == FetchOpcode::kTextureFetch) {
      ...
      // Ported from xenia-canary d1195052 + 2ddc5ef7.
      ...
      dxbc::Dest integer_scale_bits_dest(
          dxbc::Dest::R(integer_scale_bits_temp, used_result_nonzero_components));
      ...
      dxbc::Dest integer_scale_flags_dest(
          dxbc::Dest::R(integer_scale_flags_temp, used_result_nonzero_components));
      ...
      a_.OpUBFE(integer_scale_bits_dest, dxbc::Src::LU(6), dxbc::Src::LU(0, 6, 12, 18),
      ...
      a_.OpUBFE(integer_scale_bits_dest, dxbc::Src::LU(1), dxbc::Src::LU(5),
                integer_scale_bits_src);
      a_.OpMovC(integer_scale_flags_dest, integer_scale_bits_src, dxbc::Src::LF(0.5f),
                dxbc::Src::LF(1.0f));
