...
// walks the guest swizzle back to its source component's width, saturating at
// the last stored channel the same way the host swizzle expands the formats.
...
// and stay 0.
// Ported from xenia-canary d1195052 + 2ddc5ef7. Without it every integer
// num_format fetch stays normalized - the upstream commit reports that alone
// fixing black screens in dozens of titles.
